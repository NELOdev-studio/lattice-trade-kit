...
- Work inside `tradecore/` only.
- Treat `../other_repos/` and `../oanda_official_api/` as read-only references.
- Keep `src/tradecore/adapters/oanda/` for broker-specific code.
...
- Keep raw AI-generated reports and private strategy work in `../tradecore-private/`.
